...
window.Echo = new laravel_echo__WEBPACK_IMPORTED_MODULE_2__["default"]((_Echo = {
  broadcaster: "socket.io",
  host: window.location.hostname + ":" + window.laravel_echo_port
}, _defineProperty(_Echo, "broadcaster", "socket.io"), _defineProperty(_Echo, "forceTLS", false), _Echo));
